...
import {
    ...
    Favorite,              //heart icon
    FavoriteBorder,
    ChatBubbleOutline,     //comment icon
    DeleteOutline,
...
const Post = ({
   ...
   useEffect(() => {
    likes.forEach(item=>{                               //refresh karya pachi farithi reset no thai liked hoy to ej rey
...
//   // updatePost,
// } from "../../Actions/Post";
// import { getFollowingPosts, getMyPosts,  } from "../../Actions/User";                  //loadUser
// import User from "../User/User";
// import CommentCard from "../CommentCard/CommentCard";
